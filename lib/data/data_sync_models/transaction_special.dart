...
class TransactionDataSyncSpecial extends Equatable {
  ...
  const TransactionDataSyncSpecial(
      {
       this.template, 
      this.areaCode,
      this.areaName,
  ...
  factory TransactionDataSyncSpecial.fromMap(Map<String, dynamic> data) =>
      TransactionDataSyncSpecial(
  ...
  factory TransactionDataSyncSpecial.fromJson(String data) {
    return TransactionDataSyncSpecial.fromMap(
  ...
  TransactionDataSyncSpecial copyWith({
    String? template,
    String? areaCode,
    String? areaName,
    String? documentCode,
    ...
    return TransactionDataSyncSpecial(
